package exercise.javaoop.exercises.oop_1;
...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        for (int i=0; i<studentNames.size(); i++){
            ...
            // prova 2
             ...
             //System.out.println("name is: " + student.name + " age: " + student.age);
        }
    ...
    private static Student createNewStudent(String name, Integer age) {
        ...
        // prova 2
        System.out.println("Student name is "  + student.name + " and he/she is "  + student.age + " years old.");
    ...
    private static void exercise3() {
        ...
        for (int k=0; k<studentNames.size(); k++){
            createNewStudent(studentNames.get(k), studentAges.get(k));
            Student student = createNewStudent(studentNames.get(k),studentAges.get(k));
        ...
        average = average/studentAges.size();
