package exercise.javaoop.exercises.oop_4;
...
public class Exercises {
    ...
    static final int MAX_WEEKS_IN_YEAR = 52;
    static final int MAX_DAYS_IN_WEEK = 7;
    static final int MAX_HOURS_IN_DAY = 24;
    ...
    public static void exercise4() {
        ...
        for (int week = 0; week < MAX_WEEKS_IN_YEAR; week++) {
            for (int day = 0; day < MAX_DAYS_IN_WEEK; day++) {
                for (int hour = 0; hour < MAX_HOURS_IN_DAY; hour++) {
